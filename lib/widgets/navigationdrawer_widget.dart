...
class _NavigationdrawerWidgetState extends State<NavigationdrawerWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: _profileServices.getUsers(),
      builder: (context, snapshot) {
        ...
        String userName = data?['username'] ?? "Nama pengguna";
                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(userName, style: AppTextstyle.appBarTeks),
                        const SizedBox(height: 16),
                        GestureDetector(
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.pushNamed(
                          context,
                          AppRoutes.productStockHistoryScreen,
                        );
                      },
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.pushNamed(
                          context,
                          AppRoutes.profitlossReportScreen,
                        );
                      },
                    ),
                  ),
